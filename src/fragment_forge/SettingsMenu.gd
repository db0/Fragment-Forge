...
func _ready() -> void:
	...
	animate_in_deckbuilder.pressed = cfc.game_settings.animate_in_deckbuilder
...
func _on_AnimateDeckBuilder_toggled(button_pressed: bool) -> void:
	cfc.set_setting('animate_in_deckbuilder',button_pressed)
